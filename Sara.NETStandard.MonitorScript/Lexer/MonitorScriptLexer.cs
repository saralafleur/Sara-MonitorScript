...
namespace Sara.NETStandard.MonitorScript.Lexer
{
    public sealed class MonitorScriptLexer
    {
        ...
        public MonitorScriptLexer()
            : this(new ErrorSink())
        {
        }

        public MonitorScriptLexer(ErrorSink errorSink)
        {
        ...
        {
            return Keyword.IsKeyword(_builder.ToString());
        }
